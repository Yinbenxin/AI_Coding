...
记录 AI 辅助编程的实战经验，包括 Prompt 技巧、工具使用、代码案例、踩坑记录和自定义 Skill。

## 目录结构

| 目录 | 内容 |
|------|------|
| `prompts/` | Prompt 模板与优化技巧 |
| `tools/` | AI 编程工具使用经验（Claude Code、Cursor、Copilot 等） |
...
每篇内容尽量包含：**背景 → 做法 → 效果**，踩坑记录额外加上**原因 → 解决方法**。
